...
/// Append-only diagnostic log at `~/Library/Logs/OpenDict.log`.
///
...
enum Diag {
    static let url = FileManager.default
        ...
        .appendingPathComponent("Library/Logs/OpenDict.log")
    ...
    private static let queue = DispatchQueue(label: "com.opendict.diag")
